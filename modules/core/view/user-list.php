...
use zion\orm\Filter;
?>
<div class="body-content-limit container-fluid filter-page">
		...
		<div class="panel panel-default">
			...
			<div class="panel-body">
				<div class="form-group w-100">
					<label for="filter[userid][low]"  class="col-sm-3">userid</label>
			...
			<div class="panel-footer">
				...
				<button type="button" id="button-toggleFilterMode" class="btn btn-default" data-mode="simple">Alternar Modo</button>
