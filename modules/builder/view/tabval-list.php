...
$fields = array("mandt","name","key","value","sequence");
sort($fields);
?>
...
<h3>Consulta de <?=$t->entity()?></h3>
	<form class="form-inline hide-advanced-fields ajaxform" action="/zion/rest/builder/Tabval/" method="POST" data-callback="defaultFilterCallback">
		<br>
		<div class="card">
			...
			<div class="card-footer">
				...
				<a id="button-new" class="btn btn-outline-info" href="/zion/mod/builder/Tabval/new" target="_blank">Novo</a>
			</div>
		</div>
	</form>
