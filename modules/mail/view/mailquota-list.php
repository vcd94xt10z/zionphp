...
<br>
<h3>Consulta de MailQuota</h3>
	<form class="form-inline hide-advanced-fields ajaxform" action="/zion/rest/mail/MailQuota/" method="POST" data-callback="defaultFilterCallback">
		<br>
		<div class="card">
			...
			<div class="card-footer">
				...
				<a id="button-new" class="btn btn-outline-info" href="/zion/mod/mail/MailQuota/new" target="_blank">Novo</a>
			</div>
		</div>
	</form>
