...
<div class="container-fluid">
	...
	<form class="form-horizontal ajaxform form-<?=$action?>" action="/zion/rest/mail/Quota/" method="<?=$method?>" data-callback="defaultRegisterCallback" data-accept="text/plain">
		<br>
		<div class="card">
