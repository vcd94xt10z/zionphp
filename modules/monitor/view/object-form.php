...
<div class="container-fluid">
	...
	<form class="form-horizontal ajaxform form-<?=$action?>" action="/zion/rest/monitor/Object/" method="<?=$method?>" data-callback="defaultRegisterCallback" data-accept="text/plain">
		<br>
		<div class="card">
