...
<div class="container-fluid">
	...
	<div class="row">
		<div class="col-12">
			...
			<form class="ajaxform" method="POST" action="/zion/mod/sslgen/SSLGen/exec" data-callback="callbackForm">
            	...
            	<div class="form-group row">
              	...
              	<div class="form-group row">
                	<label for="site_alt_ip" class="col-4 col-form-label">Alt IP</label> 
                	<div class="col-8">
                		<?php
                		$lines   = array();
                		$lines[] = "127.0.0.1";
		...
		<div class="col-12 zcode_area">
			...
			<div id="code-ext"></div>
			<div id="code-scriptCA"></div>
			<div id="code-scriptSite"></div>
